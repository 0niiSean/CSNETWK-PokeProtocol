...
export function parseHeader(rawData) {
    ...
    for (const line of lines) {
        ...
        } else if (key === RELIABILITY_FIELDS.SEQUENCE_NUMBER) { // FIX: Use RELIABILITY_FIELDS directly
            header.sequence_number = Number(value); 
        } else if (key === RELIABILITY_FIELDS.ACK_NUMBER) {       // FIX: Use RELIABILITY_FIELDS directly
